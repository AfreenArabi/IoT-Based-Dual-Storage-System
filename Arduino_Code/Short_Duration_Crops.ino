...
// ---------------- WIFI + THINGSPEAK ----------------
#define WIFI_SSID "SRC 24.G"
#define WIFI_PASS "src@internet"
#define CHANNEL_ID 3254798
#define WRITE_API_KEY "0V11I9P0T55QAAA7"
...
#define vs    27
// Thresholds
#define GAS1_LIMIT 110
#define GAS2_LIMIT 140
#define GAS3_LIMIT 110
#define GAS4_LIMIT 140
#define TEMP1_LIMIT 31
#define TEMP2_LIMIT 34
int prt=30;
int prh=55;
int prt2=30;
int prh2=55;
...
void loop() {
  ...
  // -------- READ SET 1 --------
  int gas1_s1 = (analogRead(GAS1_S1)*1.2)/6;
  ...
  // -------- READ SET 2 --------
  int gas1_s2 = analogRead(GAS1_S2)/6;
